  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, Aishwarya excels in
      ...
      <br />
      <span>
        Aishwarya Sekhri is dedicated to leveraging her expertise to contribute to
      ...
      <p>
        Beyond her professional achievements, Aishwarya is a big fan of cricket and
        holds immense admiration for <strong> King Kohli.</strong> Her  favorite
        person and biggest inspiration is her  brother,{" "}
        <strong>Hardik.</strong> Their friendly rivalry and deep bond have
        significantly shaped Aishwarya’s journey. Harry is not only a great
        competitor but also a steadfast friend, constantly motivating Aishwarya to
